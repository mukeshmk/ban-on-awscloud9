...
device.on('connect', function() {
    ...
    // subscribing to 'scalable/server/ph-value-sensor' for info about the routing.
    device.subscribe(serverTopic + deviceName);
    // subscribing to 'scalable/cmd/ph-value-sensor' for interaction with the command line interface.
