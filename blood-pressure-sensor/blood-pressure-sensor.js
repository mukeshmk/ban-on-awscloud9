...
device.on('connect', function() {
    ...
    // subscribing to 'scalable/server/blood-pressure-sensor' for info about the routing.
    device.subscribe(serverTopic + deviceName);
    // subscribing to 'scalable/cmd/blood-pressure-sensor' for interaction with the command line interface.
