...
device.on('connect', function() {
    ...
    // subscribing to 'scalable/sink/ecg-sensor' for charger notifications.
    device.subscribe(sinkTopic + deviceName);
    // subscribling to 'scalable/ecg-sensor/dump' for notficiation about which node to dump too.
    device.subscribe(scalable + deviceName + dump);
    // subscribling to 'scalable/ecg-sensor/dump/receive' for notficiation about being the dump node.
    device.subscribe(scalable + deviceName + dumprev);
    // subscribing to 'scalable/server/ecg-sensor' for info about the routing.
    device.subscribe(serverTopic + deviceName);
    // subscribing to 'scalable/cmd/ecg-sensor' for interaction with the command line interface.
