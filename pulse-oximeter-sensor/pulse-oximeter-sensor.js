...
device.on('connect', function() {
    ...
    // subscribing to 'scalable/server/pulse-oximeter-sensor' for info about the routing.
    device.subscribe(serverTopic + deviceName);
    // subscribing to 'scalable/cmd/pulse-oximeter-sensor' for interaction with the command line interface.
