...
device.on('connect', function() {
    ...
    // subscribing to 'scalable/server/heart-beat-sensor' for info about the routing.
    device.subscribe(serverTopic + deviceName);
    // subscribing to 'scalable/cmd/heart-beat-sensor' for interaction with the command line interface.
